...
//                new EmojiBean(R.mipmap.sy_emoji_0031, "[坏笑]"),
                ...
                new EmojiBean(R.mipmap.sy_emoji_0032, "[赞]"),
                new EmojiBean(R.mipmap.sy_emoji_0033, "[开心是富]"),
                new EmojiBean(R.mipmap.sy_emoji_0034, "[早安]"),
                new EmojiBean(R.mipmap.sy_emoji_0035, "[送你小花]"),
                new EmojiBean(R.mipmap.sy_emoji_0036, "[早睡早起]"),
                new EmojiBean(R.mipmap.sy_emoji_0037, "[哈哈]"),
                new EmojiBean(R.mipmap.sy_emoji_0038, "[厉害了]"),
                new EmojiBean(R.mipmap.sy_emoji_0039, "[哦科]"),
                new EmojiBean(R.mipmap.sy_emoji_0040, "[按时吃药哦]"),
                new EmojiBean(R.mipmap.sy_emoji_0041, "[流泪]"),
                new EmojiBean(R.mipmap.sy_emoji_0042, "[拜]"),
                new EmojiBean(R.mipmap.sy_emoji_0043, "[无语]"),
                new EmojiBean(R.mipmap.sy_emoji_0044, "[爱你哦]"),
                new EmojiBean(R.mipmap.sy_emoji_0045, "[早日康复]"),
                new EmojiBean(R.mipmap.sy_emoji_0046, "[抱抱]"),
                new EmojiBean(R.mipmap.sy_emoji_0047, "[加油]"),
                new EmojiBean(R.mipmap.sy_emoji_0048, "[对]"),
                new EmojiBean(R.mipmap.sy_emoji_0049, "[错]"),
                new EmojiBean(R.mipmap.sy_emoji_0050, "[工作中]"),
                new EmojiBean(R.mipmap.sy_emoji_0051, "[来了]"),
                new EmojiBean(R.mipmap.sy_emoji_0052, "[运动健康]"),
                new EmojiBean(R.mipmap.sy_emoji_0053, "[不开心]"),
                new EmojiBean(R.mipmap.sy_emoji_0054, "[击掌]"),
                new EmojiBean(R.mipmap.sy_emoji_0055, "[我们一起面对]"),
